...
import { Home, Users, Settings, X, LogOut, BookOpen, UserLock, GraduationCap, UserStar, Package, LayoutList } from "lucide-react";
...
const navLinks = [
  ...
  { name: "Orders", href: "/orders", icon: LayoutList },
